    ...
    Public Shared Function Presets() As LightRigPreset()
        ...
        Return New LightRigPreset() {
            ...
            New LightRigPreset("Portrait",
                ...
                New PreviewLightRig With {
                    .KeyLight = New PreviewLight(1.0F, azimuthDeg:=45.0F, elevationDeg:=45.0F, color:=New RigColor(1.0F, 0.97F, 0.93F), castsShadow:=True),
                    .FillLeft = New PreviewLight(0.5F, azimuthDeg:=315.0F, elevationDeg:=45.0F, color:=New RigColor(0.94F, 0.96F, 1.0F), castsShadow:=False),
                    .FillRight = New PreviewLight(0.0F, azimuthDeg:=0.0F, elevationDeg:=0.0F, color:=New RigColor(1.0F, 0.98F, 0.95F), castsShadow:=False),
                    .BackLight = New PreviewLight(0.3F, azimuthDeg:=180.0F, elevationDeg:=45.0F, color:=New RigColor(1.0F, 0.95F, 0.88F), castsShadow:=False),
