...
Public Module SseFaceGenBaker
    ...
    Private ReadOnly InvG24Baker As Single = CSng(1.0 / 2.4)
            ...
            Sub(range)
                For i = range.Item1 To range.Item2 - 1
                    For ch = 0 To 2
                        ...
                        Dim sl = clin * clin + 2.0F * clin * tint * (1.0F - clin)      ' softlight(complexion_lin, tint)
                        ...
                        complexionRgba(i * 4 + ch) = Lin2Srgb(sl * FgTintChannelClamped(det, ch))
                    Next
                Next
            End Sub)
    End Sub
    ...
    Public Function Lin2Srgb(c As Single) As Single
        ...
        Return 1.055F * MathF.Pow(c, InvG24Baker) - 0.055F
    End Function
